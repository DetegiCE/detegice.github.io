...
<script>
  window.onload = function() {
    ...
    // setting sises
    var priArr1 = new Array(100000, 200000, 400000, 
...
<div class="alert alert-danger" role="alert">
    <h4 class="alert-heading">2020년 10월 2일 기준 시세</h4>
    <hr>
    <p class="mb-0" style="display: inline;">시세가 없는 물품은 자유 시세로 가능합니다.<br>
        ...
        <hr>
        금액 위에 마우스를 올리면 시세 범위를 확인하실 수 있습니다.<br>R 재료, R 상자의 경우 최저 시세만 존재합니다.
    </div>
<div>
